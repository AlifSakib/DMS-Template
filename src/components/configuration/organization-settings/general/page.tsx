        ...
        <Container>
            ...
            <div className="grid grid-cols-2 gap-4">
                    <div className="col-span-2  flex flex-col gap-2 lg:gap-5 lg:flex-row lg:items-center ">
                        <Label htmlFor="hrFullName2" className="lg:min-w-[260px] lg:text-end">Microsoft Office Online</Label>
                        <div className="w-full">
                        <FormCheckbox
                            name="microsoft_office_online"
                            options={[
                                { id: 'opt1', label: 'Enable online editing of Microsoft Office files', value: "false" },
            ...
            <div className="grid grid-cols-2 gap-4">
                    <div className="col-span-2  flex flex-col gap-2 lg:gap-5 lg:flex-row lg:items-center ">
                        <Label htmlFor="hrFullName2" className="lg:min-w-[260px] lg:text-end">Microsoft Teams Integration</Label>
                        <div className="w-full">
                        <FormCheckbox
                            name="microsoft_teams_integration"
                            options={[
                                { id: 'opt1', label: 'Enable the sharing functionality with Microsoft Teams', value: "false" },
                                // Add more options as needed
                                ]}
            ...
            <div className="grid grid-cols-2 gap-4">
                    <div className="col-span-2  flex flex-col gap-2 lg:gap-5 lg:flex-row lg:items-center ">
                        <Label htmlFor="hrFullName2" className="lg:min-w-[260px] lg:text-end">Organization GUID</Label>
                        <div className="w-full">
                        <FormInput name="passphrase" placeholder="Demo ID" size="small" />
                        </div>
                    </div> 
                    <div className="col-span-2  flex flex-col gap-2 lg:gap-5 lg:flex-row lg:items-center ">
                        <Label htmlFor="hrFullName2" className="lg:min-w-[260px] lg:text-end">Customer Experience Improvement Program (CEIP)</Label>
                        <div className="w-full">
                        <FormCheckbox
                            name="customer_experience_improvement_program_(CEIP)"
                            options={[
                                { id: 'opt1', label: 'Customer Experience Improvement Program (CEIP)', value: "false" },
                                // Add more options as needed
                                ]}
            ...
            <div className="col-span-2  flex flex-col gap-2 lg:gap-5 lg:flex-row lg:items-center ">
                        <Label htmlFor="hrFullName2" className="lg:min-w-[260px] lg:text-end">Language</Label>
                    ...
                    <div className="col-span-2  flex flex-col gap-2 lg:gap-5 lg:flex-row lg:items-center ">
                        <Label htmlFor="hrFullName2" className="lg:min-w-[260px] lg:text-end">Date/Number format</Label>
                    ...
                    <div className="col-span-2  flex flex-col gap-2 lg:gap-5 lg:flex-row lg:items-center ">
                        <Label htmlFor="hrFullName2" className="lg:min-w-[260px] lg:text-end">Time Zone</Label>
                    ...
                    <div className="col-span-2  flex flex-col gap-2 lg:gap-5 lg:flex-row  ">
                        <Label htmlFor="hrFullName2" className="lg:min-w-[260px] lg:text-end lg:mt-3">Working days</Label>
                        <div className="w-full">
                        <FormCheckbox
                            name="working_days"
                            options={[
                    ...
                    <div className="col-span-2  flex flex-col gap-2 lg:gap-5 lg:flex-row  ">
                        <Label htmlFor="hrFullName2" className="lg:min-w-[260px] lg:text-end lg:mt-3">Working time</Label>
                        <div className="flex gap-4">
                        <div className="w-40">
                        <FormInput name="working_time" placeholder="Demo Time"  type="time" />
                        </div>
                        <div className="w-40">
                        <FormInput name="working_time" placeholder="Demo Time" type="time" />
                        </div>
                    ...
                    <div className="col-span-2  flex flex-col gap-2 lg:gap-5 lg:flex-row  ">
                        <Label htmlFor="hrFullName2" className="lg:min-w-[260px] lg:text-end lg:mt-3">Holidays</Label>
                        <div className="flex gap-4">
