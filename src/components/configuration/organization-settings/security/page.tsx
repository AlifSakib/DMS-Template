...
const OrganizationSecuritylSettings = () => {
    ...
    return (
        <Container>
            <SectionTitle title="Login" tag="h6" weight="medium"  />
                <div className="grid grid-cols-2 gap-4">
                    <div className="col-span-2  flex flex-col gap-2 lg:gap-5 lg:flex-row lg:items-center ">
                        <Label htmlFor="hrFullName2" className="lg:min-w-[260px] lg:text-end">Single Sign-On</Label>
                        <div className="w-full">
                        <FormCheckbox
                            name="single-sign-on"
                            options={[
                                { id: 'opt1', label: 'Enable single sign-on with your identity provider', value: "false" },
                    ...
                    <div className="col-span-2  flex flex-col gap-2 lg:gap-5 lg:flex-row lg:items-center ">
                        <Label htmlFor="hrFullName2" className="lg:min-w-[260px] lg:text-end">Guest Login</Label>
                        <div className="w-full">
                        <FormCheckbox
                            name="guest-login"
                            options={[
                                { id: 'opt1', label: 'Enable to log in as a guest with a predefined DocuWare user', value: "false" },
                                // Add more options as needed
                                ]}
                    ...
                    <div className="col-span-2  flex flex-col gap-2 lg:gap-5 lg:flex-row lg:items-center ">
                        <Label htmlFor="hrFullName2" className="lg:min-w-[260px] lg:text-end"></Label>
                        <div className="flex items-center gap-4">
                       <FormInput name="change user" placeholder="No user specified" size="large" />
            ...
            <div className="grid grid-cols-2 gap-4">
                    <div className="col-span-2  flex flex-col gap-2 lg:gap-5 lg:flex-row lg:items-center ">
                        <Label htmlFor="hrFullName2" className="lg:min-w-[260px] lg:text-end">Password Policy</Label>
                        <div className="w-full">
                        <FormCheckbox
                            name="password-policy"
                            options={[
                                { id: 'opt1', label: 'Enforce a password policy for DocuWare passwords', value: "false" },
                                // Add more options as needed
                                ]}
                    ...
                    <div className="col-span-2  flex flex-col gap-2 lg:gap-5 lg:flex-row lg:items-center ">
                        <Label htmlFor="hrFullName2" className="lg:min-w-[260px] lg:text-end">Passphrase</Label>
                        <div className="flex items-center gap-4">
                       <FormInput name="passphrase" placeholder="Demo Passphase" size="large" />
                       <div className="w-[300px]">
                       <Title as="h6" fontWeight="normal">
                            Change passphrase
                       </Title>
            ...
            <div className="grid grid-cols-2 gap-4">
                    <div className="col-span-2  flex flex-col gap-2 lg:gap-5 lg:flex-row lg:items-center ">
                        <Label htmlFor="hrFullName2" className="lg:min-w-[260px] lg:text-end">Automatic log out</Label>
                        <div className="w-full">
                        <FormCheckbox
                            name="automatic-log-out"
                            options={[
                                { id: 'opt1', label: 'Log out automatically after being inactive for', value: "false" },
                                // Add more options as needed
                                ]}
            ...
            <div className="grid grid-cols-2 gap-4">
                    <div className="col-span-2  flex flex-col gap-2 lg:gap-5 lg:flex-row lg:items-center ">
                        <Label htmlFor="hrFullName2" className="lg:min-w-[260px] lg:text-end">Restricted File Types</Label>
                        <div className="w-full">
                        <Title as="h6" fontWeight="normal">
